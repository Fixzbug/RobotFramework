...
def save_data(predefined_title, new_data, filename="data.xlsx", sheet_name="Sheet1"):
    ...
    if file_exists:
        ...
        sheet.append([predefined_title])  # Add title to the first row for new workbook
    ...
    for i, data in enumerate(new_data, start=2):  # Start at row 2 because row 1 is the header
